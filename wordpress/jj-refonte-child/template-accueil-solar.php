 ...
 * sections épinglées, visuels détourés dans les cartes secteurs.
  ...
  <div class="sectors__pin" id="sectors-pin">
    ...
    <div class="sectors__viewport">
      <div class="sectors__track" id="sectors-track">
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          <span class="sector__idx">S / 01</span>
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-renovation.webp" alt="Achat de leads qualifiés rénovation énergétique" loading="lazy" width="760" height="718"></span>
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          ...
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-immobilier.webp" alt="Achat de leads qualifiés immobilier" loading="lazy" width="760" height="752"></span>
          <h3>Immobilier</h3>
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          ...
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-assurance.webp" alt="Achat de leads qualifiés assurance" loading="lazy" width="555" height="760"></span>
          <h3>Assurance</h3>
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          ...
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-finance.webp" alt="Achat de leads qualifiés finance et crédit" loading="lazy" width="728" height="760"></span>
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          ...
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-telecom.webp" alt="Achat de leads qualifiés télécom et énergie" loading="lazy" width="492" height="760"></span>
        ...
        <a class="sector glass" data-tilt href="https://jj-computer.fr/achat-leads-qualifies-secteurs/">
          ...
          <span class="sector__stage"><img src="<?php echo esc_url( $jj_assets ); ?>/images/secteurs/secteur-automobile.webp" alt="Achat de leads qualifiés automobile" loading="lazy" width="760" height="574"></span>
          <h3>Automobile</h3>
